...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-md-12 feature table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #ffffff; text-align: left; vertical-align: top;">
                                <img src="https://www.cttc.gov.in/images/lr.jpg" width="120" height="156" /></td>
		        ...
		        <br />
                        ...
                        <tr>
                            ...
                            <td style="background-color: #ffffff; text-align: left; vertical-align: top;">
                                <img src="https://www.cttc.gov.in/images/kmr.jpg" width="120" height="157" /></td>
                            <td style="background-color: #ffffff; text-align: left; vertical-align: top;"><strong>Mr. Rajan K.M.</strong>
                                <br />
                                Senior Manager (Training)</td>
                            <td style="background-color: #ffffff; text-align: left; vertical-align: top;">B-36, Chandaka Ind. Area, Patia,Bhubaneswar-751024</td>
                            <td style="background-color: #ffffff; text-align: left; vertical-align: top;">Ph - 9337118456
                                <br />
    ...
    <HeaderTemplate>
        <table class="table table-bordered">
            <tr style="background:#2d3490;color:#fff;">
                <th>SL No</th>
                <th>Photograph</th>
                <th>Contact Person with Designation</th>
                <th>Address</th>
    ...
    <ItemTemplate>
        <tr>
            ...
            <td>
                <img src='<%# Eval("PhotoPath") %>' width="90" />
            </td>
            <td>
