<%@ Page Title="" Language="C#" MasterPageFile="~/igtr.Master" AutoEventWireup="true" CodeBehind="BhavnagarCourse.aspx.cs" Inherits="igtrahd.BhavnagarCourse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="panel">
    <div class="panel-heading">
      <h3 class="panel-title">Bhavnagar Medium and Short Term Course</h3>
    </div>
          ...
          <div class="mix-grid">
            <div class="mix category_1 mix_all" style="display: block; opacity: 1; ">
              ...
              <div class="mix-details">
                  <a data-rel="fancybox-button" href="images/MTC-Bhavnagar.jpg" class="mix-preview fancybox-button"><i class="fa fa-search"></i></a>
              </div>
              </div>
             </div>
          </div>         
        ...
        <div class="panel">
          ...
          <div class="mix-grid">
            <div class="mix category_1 mix_all" style="display: block; opacity: 1; ">
              ...
              <div class="mix-details">
                  <a data-rel="fancybox-button" href="images/STC-Bhavnagar.jpg" class="mix-preview fancybox-button"><i class="fa fa-search"></i></a>
              </div>
              </div>
             </div>
          </div> 
          ...
          <p><strong>Indo German Tool Room (IGTR) Extension Centre, Bhavnagar</strong></p>
