...
{
    public partial class ListProductionInq : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = DBCommunication.SelectProductionInq();
            if (dt.Rows.Count != 0)
            {
                rptProductionInq.DataSource = dt;
                rptProductionInq.DataBind();
            }
            else {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
             ...
             if (dt != null)
             {
                 if (dt.Rows.Count != 0)
                 {
                     ...
                     htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>Organisation</td>");
                     ...
                     htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>Message</td>");
                     htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>Referance</td>");
                     ...
                     foreach (DataRow dr in dt.Rows)
                     {
                         ...
                         htmlReportBuilder.Append("<td style='" + REPORT_CELL_LEFT + "'>");
                         htmlReportBuilder.Append(Convert.ToString(dr["Organization"]));
                         htmlReportBuilder.Append("</td>");
                         ...
                         htmlReportBuilder.Append("<td style='" + REPORT_CELL_LEFT + "'>");
                         htmlReportBuilder.Append(Convert.ToString(dr["Message"]));
                         htmlReportBuilder.Append("</td>");
                     ...
                     if (String.IsNullOrEmpty(fileName))
                         fileName = "Production" + DateTime.Now.ToString("yyyyMMdd-HHmmss") + ".xls";
