...
{
    public partial class ListTrainingInq : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = DBCommunication.SelectTrainingInq();
            if (dt.Rows.Count != 0)
            {
                rptTrainingInq.DataSource = dt;
                rptTrainingInq.DataBind();
            }
            else
            {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (dt != null)
            {
                if (dt.Rows.Count != 0)
                {
                    ...
                    htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>Name</td>");
                    ...
                    htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>Fax No</td>");
                    htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>E-mail</td>");
                    htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>Area of Interest</td>");
                    htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>Qualification</td>");
                    htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>Specific Requirement or Other Details</td>");
                    htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>Reference</td>");
                    htmlReportBuilder.Append("<td style='" + REPORT_HEADER_LEFT + "'>Current Status</td>");
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        htmlReportBuilder.Append("<td style='" + REPORT_CELL_LEFT + "'>");
                        htmlReportBuilder.Append(Convert.ToString(dr["Name"]));
                        htmlReportBuilder.Append("</td>");
                        ...
                        htmlReportBuilder.Append("<td style='" + REPORT_CELL_LEFT + "'>");
                        htmlReportBuilder.Append(Convert.ToString(dr["FaxNo"]));
                        htmlReportBuilder.Append("</td>");
                        ...
                        htmlReportBuilder.Append("<td style='" + REPORT_CELL_LEFT + "'>");
                        htmlReportBuilder.Append(Convert.ToString(dr["AOI"]));
                        htmlReportBuilder.Append("</td>");

                        htmlReportBuilder.Append("<td style='" + REPORT_CELL_LEFT + "'>");
                        htmlReportBuilder.Append(Convert.ToString(dr["Qualification"]));
                        htmlReportBuilder.Append("</td>");

                        htmlReportBuilder.Append("<td style='" + REPORT_CELL_LEFT + "'>");
                        htmlReportBuilder.Append(Convert.ToString(dr["SpecReq"]));
                        htmlReportBuilder.Append("</td>");

                        htmlReportBuilder.Append("<td style='" + REPORT_CELL_LEFT + "'>");
                        htmlReportBuilder.Append(Convert.ToString(dr["Reference"]));
                        htmlReportBuilder.Append("</td>");

                        htmlReportBuilder.Append("<td style='" + REPORT_CELL_LEFT + "'>");
                        htmlReportBuilder.Append(Convert.ToString(dr["CurrentStatus"]));
                        htmlReportBuilder.Append("</td>");
                    ...
                    if (String.IsNullOrEmpty(fileName))
                        fileName = "Training" + DateTime.Now.ToString("yyyyMMdd-HHmmss") + ".xls";
