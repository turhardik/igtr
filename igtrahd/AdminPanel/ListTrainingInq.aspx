<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.Master" AutoEventWireup="true" CodeBehind="ListTrainingInq.aspx.cs" Inherits="igtrahd.AdminPanel.ListTrainingInq" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <h3> List Training Inquiry</h3>
    <div>
         <center>
         ...
         <asp:repeater id="rptTrainingInq" runat="server">
                <HeaderTemplate>
